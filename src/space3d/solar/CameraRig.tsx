...
function computeGoal(
  ...
  if (view === "synth") {
    ...
    // The satellite close-up: perch just above the satellite, on the far
    // side from the sun, close enough that the head fills the frame with
    // its antenna cone running off the edge (satellitePerchPose — shared
    // with Satellite, which lays its link parts out for that pose). Rides
    // the satellite's orbit (Earth's angular speed, like the home perch).
