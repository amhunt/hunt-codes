...
const Resume = () => {
  ...
  return (
    ...
    <div className="resume-inner-container">
      ...
      <h1>About me</h1>
      <p>
        Hey! I’m a web engineer in San Francisco. For consulting inquiries, reach out to{" "}
      ...
      <ul>
        <li>Frontend architecture and dev experience: increase frontend dev velocity, reduce bugs, and improve product/UX quality</li>
        <li>Component systemization</li>
        <li>Product: Working closely with designers + researchers to build delightful, interactive web products
          <ul>
            <li><em>E.g. data viz, games, marketing pages, animation, search experiences</em></li>
          </ul>
        </li>
      ...
      <p>
       <b>Things I know well</b> (in order)<b>:</b> TypeScript/JavaScript, React, ESLint, Cloudflare, Webpack, D3, Visx, Webflow, Jest, Storybook, Chromatic, Redux, S3, Material UI, GitHub Actions, GraphQL, Vue
      </p>
      <p>
       <b>Things I know <em>less</em> well:</b> Python, Tailwind CSS, Bootstrap, Solidity, Java
      </p>
      <h2>Experience</h2>
      ...
      <li>Componentization: Lead efforts to dedupe, standardize, and improve interactions for shared components, swapping out Bootstrap for Material UI</li>
      <li>Dev infra – CI/Quality:
      <ul>
        <li>TypeScript correctness + coverage CI checks</li>
        <li>Testing: Jest unit testing, Datadog Synthetic tests, and visual regression testing via Storybook/Chromatic</li>
        <li>Built FE/BE logging system with Segment</li>
      </ul>
      </li>
      <li>
        Dev infra – build + deploy: Architected much of Zip's current frontend build systems, across Webpack, Jenkins, Docker, S3, Cloudflare, and Webflow (marketing site)
      </li>
      <li>Dev experience: enabled hot reloads, sourcemaps, and robust lint rules to encourage modern, standardized TS/React practices</li>
      <li>TypeScript: enabled TypeScript and led migration of frontend code to 90% coverage</li>
      <li>Performance: reduced page load times by 50%, primarily via code splitting (70% core bundle size reduction) and routing optimization</li>
      <div className="splitRow">
        <h3 className="firstSplitRowItem">
      ...
      <li>
        Ran &gt;20 A/B tests, resulting in a compounded bookings
        lift of &gt;10% for the Experiences product
      </li>
      <li>
      ...
      <li>
        Helped design + build a gamified CAD learning app for students
      </li>
      <li>
